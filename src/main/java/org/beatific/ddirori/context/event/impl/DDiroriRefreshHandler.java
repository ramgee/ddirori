...
@Component
@EventListener
public class DDiroriRefreshHandler extends AbstractEventHandler<DDiroriStartEvent> implements ApplicationListener<ContextRefreshedEvent> {
	...
	public void onApplicationEvent(ContextRefreshedEvent paramE) {
		...
		synchronized(DDiroriRefreshHandler.class) {
	...
	@Override
	protected void handleMyEvent(DDiroriStartEvent event) {
